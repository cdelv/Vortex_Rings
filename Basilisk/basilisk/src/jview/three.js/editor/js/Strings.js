function Strings( config ) {
	...
	var values = {
		...
		en: {
			...
			'menubar/file/export/basilisk': 'Export Basilisk',
			...
			'menubar/add/cameralight': 'CameraLight',
			...
			'sidebar/settings/shortcuts/visible': 'Visible',
		...
		fr: {
			...
			'menubar/add/cameralight': 'Lumière caméra',
