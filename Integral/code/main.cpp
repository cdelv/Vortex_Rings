...
struct Config
{
    ...
    double W = 30.0;    //Mean Vorticity

    //Integral Parameters
    double Int_eps = 1E-14; 
    double Int_cutoff = 2.5;
    int depth = 3;
...
double Integral(const Vector &r, double t, int coord){
    ...
    /*double d = std::sqrt((r(0)-Parameters.Rx)*(r(0)-Parameters.Rx)+(r(1)-Parameters.Ry)*(r(1)-Parameters.Ry)+(r(2)-Parameters.Rz)*(r(2)-Parameters.Rz)); 
    if (d>Parameters.Int_cutoff)
        return 0.0;*/

    double x1 = Parameters.Rx-Parameters.a;
    double x2 = Parameters.Rx+Parameters.a;
    double y1 = Parameters.Ry-Parameters.R-Parameters.a;
    double y2 = Parameters.Ry+Parameters.R+Parameters.a;
    double z1 = Parameters.Rz-Parameters.R-Parameters.a;
    double z2 = Parameters.Rz+Parameters.R+Parameters.a;
